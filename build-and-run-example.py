...
def main(args=sys.argv):
  ...
  # If example_name is a path to a binary, do not bother to compile an example program.
  if os.path.exists(example_name):
    print(f'Running directly {example_name}')
    test_binary_path = str(example_name)
  else:
